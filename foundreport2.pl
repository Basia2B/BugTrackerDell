...
my $content ='';
$content .= "Components, Severity 1, Severity 2, Severity 2, Severity 3, Severity 4, Severity 5";
for $name (keys %cmpt) 
{
	$content .= "\n" if $content;
	$content .= "$name";
