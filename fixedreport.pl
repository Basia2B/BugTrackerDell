...
my $sqlcountone = 'select count(*) from bugs_activity
		where bug_when > "2012-07-23" and bugs_activity.bug_id in ( select bug_id from bugs 
								  ...
								  and cf_target_release in ( "1.1.0" ) and resolution IN ("FIXED") and bug_severity="S1 - DU/DL" and component_id=? )
...
my $sqlcounttwo = 'select count(*) from bugs_activity
		where bug_when > "2012-07-23" and bugs_activity.bug_id in ( select bug_id from bugs 
								  where product_id in (2) and bug_status IN ("RESOLVED","VERIFIED")
								  and cf_target_release in ( "1.1.0" ) and resolution IN ("FIXED") and bug_severity="S2 - Major (Crash/Broken Feature)" and component_id=? )
...
my $sqlcountthree = 'select count(*) from bugs_activity
		where bug_when > "2012-07-23" and bugs_activity.bug_id in ( select bug_id from bugs 
								  where product_id in (2) and bug_status IN ("RESOLVED","VERIFIED")
								  and cf_target_release in ( "1.1.0" ) and resolution IN ("FIXED") and bug_severity="S3 - Minor (Cosmetic)" and component_id=? )
...
my $sqlcountfour = 'select count(*) from bugs_activity
		where bug_when > "2012-07-23" and bugs_activity.bug_id in ( select bug_id from bugs 
								  where product_id in (2) and bug_status IN ("RESOLVED","VERIFIED")
								  and cf_target_release in ( "1.1.0" ) and resolution IN ("FIXED") and bug_severity="S4 - Enhancement Request" and component_id=? )
...
my $sqlcountfive = 'select count(*) from bugs_activity
		where bug_when > "2012-07-23" and bugs_activity.bug_id in ( select bug_id from bugs 
								  where product_id in (2) and bug_status IN ("RESOLVED","VERIFIED")
								  and cf_target_release in ( "1.1.0" ) and resolution IN ("FIXED") and bug_severity="S5 - Task Tracking" and component_id=? )
