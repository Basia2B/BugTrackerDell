...
#Query for severity one FOUND bugs
my $sqlcountone = 'select count(*) from bugs where product_id IN (2) and 
								 creation_ts >= "2012-07-27" and creation_ts <= "2012-08-03" and cf_target_release IN ("1.1.0")
								and bug_severity= "S1 - DU/DL"';
							
							
#Query for severity two FOUND bugs	
my $sqlcounttwo = 'select count(*) from bugs where product_id IN (2) and 
								  creation_ts >= "2012-07-27" and creation_ts <= "2012-08-03" and cf_target_release IN ("1.1.0")
								and bug_severity= "S2 - Major (Crash/Broken Feature)"';
#Query for severity three FOUND bugs	
my $sqlcountthree = 'select count(*) from bugs where product_id IN (2) and 
								  creation_ts >= "2012-07-27" and creation_ts <= "2012-08-03" and cf_target_release IN ("1.1.0")
								and bug_severity= "S3 - Minor (Cosmetic)"';	
#Query for severity four FOUND bugs		
my $sqlcountfour = 'select count(*) from bugs where product_id IN (2) and 
								  creation_ts >= "2012-07-27" and creation_ts <= "2012-08-03" and cf_target_release IN ("1.1.0")
								and bug_severity= "S4 - Enhancement Request"';	
#Query for severity five FOUND bugs		
my $sqlcountfive = 'select count(*) from bugs where product_id IN (2) and 
								  creation_ts >= "2012-07-27" and creation_ts <= "2012-08-03" and cf_target_release IN ("1.1.0")
								and bug_severity= "S5 - Task Tracking"';	



my $sqltotal = 'select count(*) from bugs where product_id IN (2) and 
								 creation_ts >= "2012-07-27" and creation_ts <= "2012-08-03" and cf_target_release IN ("1.1.0")';	
...
write2file( 'foundtrend.csv', $content);
