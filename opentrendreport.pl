...
#Query for severity one OPEN bugs
my $sqlcountone = 'select count(*) from bugs where product_id in (2)
							and bug_status IN ("NEW","ASSIGNED","ARBITRATION","NEED MORE INFO","REOPENED") and cf_target_release IN("1.1.0") and bug_severity="S1 - DU/DL"';
							
							
#Query for severity two OPEN bugs	
my $sqlcounttwo = 'select count(*) from bugs where product_id in (2)
							and bug_status IN ("NEW","ASSIGNED","ARBITRATION","NEED MORE INFO","REOPENED") and cf_target_release IN("1.1.0") and bug_severity="S2 - Major (Crash/Broken Feature)"';
#Query for severity three OPEN bugs	
my $sqlcountthree = 'Select count(*) from bugs where product_id in (2)
							and bug_status IN ("NEW","ASSIGNED","ARBITRATION","NEED MORE INFO","REOPENED") and cf_target_release IN("1.1.0") and bug_severity="S3 - Minor (Cosmetic)"';	
#Query for severity four OPEN bugs		
my $sqlcountfour = 'Select count(*) from bugs where product_id in (2)
							and bug_status IN ("NEW","ASSIGNED","ARBITRATION","NEED MORE INFO","REOPENED") and cf_target_release IN("1.1.0") and bug_severity="S4 - Enhancement Request)"';	
#Query for severity five must fix bugs		
my $sqlcountfive = 'Select count(*) from bugs where product_id in (2)
							and bug_status IN ("NEW","ASSIGNED","ARBITRATION","NEED MORE INFO","REOPENED") and cf_target_release IN("1.1.0") and bug_severity="S5 - Task Tracking"';	



my $sqltotal = 'Select count(*) from bugs where product_id in (2)
							and bug_status IN ("NEW","ASSIGNED","ARBITRATION","NEED MORE INFO","REOPENED") and cf_target_release IN("1.1.0")';	
...
write2file( 'opentrend.csv', $content);
